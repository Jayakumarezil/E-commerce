...
export const setSelectedWarranty = (state: WarrantyState, action: PayloadAction<Warranty | null>) => {
...
export const setSelectedClaim = (state: ClaimState, action: PayloadAction<Claim | null>) => {
...
export const { clearWarrantyError, clearWarranties } = warrantySlice.actions;
export const { clearClaimError, clearClaims } = claimSlice.actions;

// Export individual slices for direct import
